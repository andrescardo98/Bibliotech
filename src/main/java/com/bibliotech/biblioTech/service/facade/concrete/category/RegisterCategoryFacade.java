...
public class RegisterCategoryFacade implements Facade<CategoryDTO> {
    ...
    public void execute(final CategoryDTO dto) {
        ...
        try {
            ...
            daoFactory.cancelTransaction();
            var userMessage = MessagesCatalog.getMessageContent(MessageCode.M00000074);
            var technicalMessage = MessagesCatalog.getMessageContent(MessageCode.M00000075);
